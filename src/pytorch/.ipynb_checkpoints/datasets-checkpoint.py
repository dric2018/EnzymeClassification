...
class EnzymeDataset(Dataset):
    def __init__(self, df:pd.DataFrame, 
                 task='train',config:Config, *args, **kwargs):
    ...
    def __getitem__(self, index):
        ...
        sample_data = {
            'sequence' :  self.convert_letters_to_int(sequence = data['SEQUENCE'], 
                                                      mapping=self.letters_to_int, 
...
if __name__ == '__main__':
    ...
    ds = EnzymeDataset(df=train, task='train', max_seq_len=Config.max_seq_len)
